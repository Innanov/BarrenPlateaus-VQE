...
struct PretrainedVQE
    ...
    function PretrainedVQE(n_qubits::Int; bond_dimension::Int=2, n_layers::Int=2)
        try
            ...
            mps_circuit, mps_params = create_mps_ansatz(n_qubits; bond_dimension=bond_dimension)
            ...
            new(simple_circuit, full_circuit, simple_params, full_params, n_qubits, full_params)
        end
    end
end
...
"""
function run_vqe(vqe::PretrainedVQE, hamiltonian::AbstractBlock, 
                iters_vqe::Int, iters_train::Int;
                optimizer::Symbol=:SPSA,
                verbose::Bool=false,
                callback=nothing)
    ...
    mps_result = run_vqe(mps_vqe, hamiltonian, mps_initial_params, iters_train; 
    ...
    full_result = run_vqe(full_vqe, hamiltonian, full_initial_params, iters_vqe; 
...
"""
function run_vqe_unified(vqe::PretrainedVQE, hamiltonian::AbstractBlock, 
                        iters_vqe::Int, iters_train::Int; kwargs...)
...
"""
function run_pretrained_vqe(hamiltonian::AbstractBlock, n_qubits::Int,
                           iters_vqe::Int, iters_train::Int; kwargs...)
